    ...
    public static class TextDensity {
        ...
        public static int getExtensionTitleTextSize(Context context, int textDensity) {
            if (sTitleTextSizeCache[textDensity] == -1)
                sTitleTextSizeCache[textDensity] = context.getResources().getDimensionPixelSize(sExtensionTitleTextSizeResId[textDensity]);
        ...
        public static int getExtensionBodyTextSize(Context context, int textDensity) {
            if (sBodyTextSizeCache[textDensity] == -1)
                sBodyTextSizeCache[textDensity] = context.getResources().getDimensionPixelSize(sExtensionBodyTextSizeResId[textDensity]);
        ...
        public static int getClockTextSizeLarge(Context context, int textDensity) {
            if (sClockTextSizeLargeCache[textDensity] == -1)
                sClockTextSizeLargeCache[textDensity] = context.getResources().getDimensionPixelSize(sClockTextSizeLargeResId[textDensity]);
        ...
        public static int getClockTextSizeSmall(Context context, int textDensity) {
            if (sClockTextSizeSmallCache[textDensity] == -1)
                sClockTextSizeSmallCache[textDensity] = context.getResources().getDimensionPixelSize(sClockTextSizeSmallResId[textDensity]);
        ...
        public static int getClockDateTextSize(Context context, int textDensity) {
            if (sClockDateTextSizeCache[textDensity] == -1)
                sClockDateTextSizeCache[textDensity] = context.getResources().getDimensionPixelSize(sClockDateTextSizeResId[textDensity]);
        ...
        public static int getRowPaddingTop(Context context, int textDensity) {
            if (sRowPaddingTopCache[textDensity] == -1)
                sRowPaddingTopCache[textDensity] = context.getResources().getDimensionPixelSize(sRowPaddingTopResId[textDensity]);
        ...
        public static int getRowPaddingBottom(Context context, int textDensity) {
            if (sRowPaddingBottomCache[textDensity] == -1)
                sRowPaddingBottomCache[textDensity] = context.getResources().getDimensionPixelSize(sRowPaddingBottomResId[textDensity]);
        ...
        public static int getRowPaddingSide(Context context, int textDensity) {
            if (sRowPaddingSideCache[textDensity] == -1)
                sRowPaddingSideCache[textDensity] = context.getResources().getDimensionPixelSize(sRowPaddingSideResId[textDensity]);
